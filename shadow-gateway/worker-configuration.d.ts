/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=shadow-gateway/wrangler.jsonc shadow-gateway/worker-configuration.d.ts` (hash: 62a801dec1b9e7c19af50528caf89a83)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SHADOW_TOKEN" | "PREFLIGHT_PRIVATE_KEY">> {}
}
