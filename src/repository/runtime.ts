...
async function consumePreflightProof(environment: RuntimeEnvironment): Promise<ReleasePlanV1> {
  ...
  await rm(join(environment.cwd, ".lenso-release/preflight-proof.json"), { force: true }); return plan;
}
